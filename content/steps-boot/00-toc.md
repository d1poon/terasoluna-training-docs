...
> Java・JSP の基本文法から入り、部品ひとつずつ、順番通りに置いていけば動くところまで完成させる構成です (途中で詰まったら各 Step の「動作確認」節や `/how-to` レシピ集を参照)。
...
**Step 01-12: 動くアプリを組む**フェーズ (自分のペースで、腑に落ちるまで読みながら進める)
...
**Step 13-15: 自動テストを書く**フェーズ (実装した機能に「壊れないことを機械的に保証する網」を張る)
